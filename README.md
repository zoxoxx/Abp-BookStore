...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b6b1f5f6-48e0-48d8-b4f8-d8fed7fd2284
```

> `b6b1f5f6-48e0-48d8-b4f8-d8fed7fd2284` is the password of the certificate, you can change it to any password you want.
